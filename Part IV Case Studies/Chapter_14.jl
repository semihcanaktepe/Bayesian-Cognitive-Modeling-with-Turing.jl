...
# ╔═╡ 98a8991c-3263-40cb-a595-559975d3da53
describe(chns_m14_1[1])

# ╔═╡ 5e996083-45df-4707-ba7f-4268b7dedd87
describe(chns_m14_1[2])

# ╔═╡ 4ef7ad05-d9b6-4c0e-a76d-b4e1a0548a48
describe(chns_m14_1[3])

# ╔═╡ d04e76a3-b915-4613-824d-e7320bed9b53
plot(chns_m14_1[1])

# ╔═╡ c5310e83-44d9-45f2-9d56-8b9bf20d4c64
plot(chns_m14_1[2])

# ╔═╡ 53ebc225-e7ed-4ec0-93f5-4fb40722c326
plot(chns_m14_1[3])
...
begin
	...
	for i in 1:3
		chns_i = sample(m14_2(response[i], ns[i]), NUTS(), MCMCThreads(), 1000, 4);
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "d211814f5573a4c32615e62faa5573932626cb61"
