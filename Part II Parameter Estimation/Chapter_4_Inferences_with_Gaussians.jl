...
md"# 4. Inferences with Gaussians"

# ╔═╡ a5b0a16b-4d93-42b6-b51c-6335c76406a1
md"## 4.1. Inferring a mean and standard deviation"
...
md"## 4.3. Repeated measurement of IQ"
...
chns_m4_2 = sample(m4_2(xs), NUTS(), MCMCThreads(), 5000, 4);
...
begin
	p1 = plot(lambda, title = "lambda", legend = false,
		xlabel = "Iteration", ylabel = "Sample value")
	p2 = density(lambda, title = "lambda", legend = false, 
