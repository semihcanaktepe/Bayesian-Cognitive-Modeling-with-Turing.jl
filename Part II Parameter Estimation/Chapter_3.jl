...
# ╔═╡ dcdaa9ac-5db7-4fde-9048-28f2391fc36f
using Distributions

# ╔═╡ d2905d92-5e9e-4206-818b-312383f8d781
using StatsPlots

# ╔═╡ b5b52035-d2a6-4ac3-84f2-3bce4b3e6c71
using Libtask
...
# ╔═╡ 4b809f19-4bd9-46c0-999a-76cc93e4a2a8
plot(delta, title = "delta")

# ╔═╡ ec74c85c-67ac-483e-aa25-517a93897bd7
# Density plot of delta
density(delta, title = "delta")
...
# 3.4. Prior and posterior distribution
...
@model function m3_6(k)
	theta ~ Beta(1,1)
	p = tzeros(Float64, 500)
	for i = 1:500
		p[i] = 1/500
	end;
	n ~ Categorical(p)
	#n ~ DiscreteUniform(1, 500)
	#n ~ DiscreteNonParametric(1:500, p)
	k .~ Binomial.(n, theta)
end;
...
chns_m3_6 = sample(m3_6(kvals), NUTS(), MCMCThreads(), 1000, 4);
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "82c40306ecce98ff2ce5c72cf94456584d27468c"
